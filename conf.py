...
texinfo_documents = [
    (master_doc, 'wsfrontend', 'wsfrontend Documentation',
     author, 'wsfrontend', 'websensor Web Application frontend.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    'wsbackend':  ('https://wsbackend.readthedocs.io/en/latest/', None),
    'wscodec':  ('https://wscodec.readthedocs.io/en/latest/', None),
